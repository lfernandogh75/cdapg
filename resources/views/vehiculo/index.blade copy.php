...
@if(isset($vehiculo))
 ...
 {{--menu--}}
  @if($vehiculo->peritaje->tipo=="OTROS2") 
 {{--acordion--}}
    ...
    <div class="p-5 font-light border border-t-0 border-gray-200 dark:border-gray-700">
      @if(isset($vehiculo->peritaje->compresioncontrol))
        ...
        @endif
              ...
              @if(isset($vehiculo->peritaje->emisiongas)&&isset($vehiculo->peritaje->tarjeta))
        ...
        @if($vehiculo->peritaje->archivocontrol->activo)
        <p> <a style="color:hsl(20, 80%, 50%);"  href="/vehiculos?placa={{$vehiculo->placa}}&vehiculoindex=archivo"  tabindex="4">ARCHIVOS</a>
          @else
          <p> <a style="color:rgb(49, 230, 25);"  href="/vehiculos?placa={{$vehiculo->placa}}&vehiculoindex=archivo"  tabindex="4">ARCHIVOS</a>
        @endif
            @else
        <p> <a  href="/vehiculos?placa={{$vehiculo->placa}}&vehiculoindex=archivo"  tabindex="4">ARCHIVOS</a>
        @endif
...
{{--inicio menu motocicleta basico--}}

@if($vehiculo->peritaje->tipo=="BÁSICO" && $vehiculo->clase_vehiculo=="Motocicleta") 
{{--acordion--}}
...
@endif
<p> <a  href="/vehiculos?placa={{$vehiculo->placa}}&vehiculoindex=12"  tabindex="4" target="_blank" rel="noopener">INFORME DEL  PERITAJE</a>
  <p> <a  href="/inspeccion/{{$vehiculo->id}}"  tabindex="4" target="_blank" rel="noopener">INFORME 2 DEL  PERITAJE</a>      
 ...
 <h5 id="accordion-collapse-heading-2">
   <button style="height: 0.75rem;" type="button" class="flex items-center justify-between w-full p-5 font-medium text-left text-gray-500 border border-b-0 border-gray-200 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-800 dark:border-gray-700 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800" data-accordion-target="#accordion-collapse-body-2" aria-expanded="false" aria-controls="accordion-collapse-body-2">
     <span>PERITAJE MOTOCICLETA BASICO</span>
     <svg data-accordion-icon class="w-6 h-6 shrink-0" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
   </button>
 </h5>
 <div    id="accordion-collapse-body-2" class="hidden" aria-labelledby="accordion-collapse-heading-2">
...
@endif
{{--finacordion peritaje moto basico--}}
...
{{--inicio menu VEHICULO basico--}}

@if($vehiculo->peritaje->tipo=="BÁSICO" && ($vehiculo->clase_vehiculo=="Automóvil"||$vehiculo->clase_vehiculo=="Pesados")) 
{{--acordion--}}
...
@endif
{{--<p> <a  href="/vehiculos?placa={{$vehiculo->placa}}&vehiculoindex=12"  tabindex="4" target="_blank" rel="noopener">INFORME DEL  PERITAJE</a>--}}
  <p> <a  href="/inspeccion/{{$vehiculo->id}}"  tabindex="4" target="_blank" rel="noopener">INFORME  DEL  PERITAJE</a>      
 ...
 <h5 id="accordion-collapse-heading-2">
   <button style="height: 0.75rem;" type="button" class="flex items-center justify-between w-full p-5 font-medium text-left text-gray-500 border border-b-0 border-gray-200 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-800 dark:border-gray-700 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800" data-accordion-target="#accordion-collapse-body-2" aria-expanded="false" aria-controls="accordion-collapse-body-2">
     <span>PERITAJE VEHICULO BASICO</span>
     <svg data-accordion-icon class="w-6 h-6 shrink-0" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
   </button>
 </h5>
 <div    id="accordion-collapse-body-2" class="hidden" aria-labelledby="accordion-collapse-heading-2">
 ...
 <h5 id="accordion-collapse-heading-3">
  ...
  <div id="accordion-collapse-body-3" class="hidden" aria-labelledby="accordion-collapse-heading-3">
    <div class="p-5 font-light border border-t-0 border-gray-200 dark:border-gray-700">
      ...
      @if(isset($vehiculo->peritaje->suspensioncontrol))
      @if($vehiculo->peritaje->suspensioncontrol->activo)
      <p> <a style="color:hsl(20, 80%, 50%);"  href="/vehiculos?placa={{$vehiculo->placa}}&vehiculoindex=sm"  tabindex="4">SUSPENSION MECANIZADA</a>
       @else
       <p> <a style="color:rgb(49, 230, 25);"  href="/vehiculos?placa={{$vehiculo->placa}}&vehiculoindex=sm"  tabindex="4">SUSPENSION MACANIZADA</a>
      @endif
         @else
      <p> <a  href="/vehiculos?placa={{$vehiculo->placa}}&vehiculoindex=sm"  tabindex="4">SUSPENSION MECANIZADA</a>
      @endif
...
{{--finacordion peritaje vehiculo basico--}}
 ...
 {{--inicio menu motocicleta completo--}}

@if(($vehiculo->peritaje->tipo=="COMPLETO"||$vehiculo->peritaje->tipo=="OTROS") && $vehiculo->clase_vehiculo=="Motocicleta") 
{{--acordion--}}
...
<p>  <a   href="/hvehiculos/{{$vehiculo->peritaje->cierre->id}}" tabindex="4">HISTORICO VEHICULO </a>  <p>
@endif
...
{{--<p> <a  href="/vehiculos?placa={{$vehiculo->placa}}&vehiculoindex=12"  tabindex="4" target="_blank" rel="noopener">INFORME DEL  PERITAJE</a> --}}
 ...
 <h5 id="accordion-collapse-heading-2">
   <button style="height: 0.75rem;" type="button" class="flex items-center justify-between w-full p-5 font-medium text-left text-gray-500 border border-b-0 border-gray-200 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-800 dark:border-gray-700 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800" data-accordion-target="#accordion-collapse-body-2" aria-expanded="false" aria-controls="accordion-collapse-body-2">
     <span>PERITAJE MOTOCICLETA </span>
     <svg data-accordion-icon class="w-6 h-6 shrink-0" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
   </button>
 </h5>
 <div    id="accordion-collapse-body-2" class="hidden" aria-labelledby="accordion-collapse-heading-2">
...
@if($vehiculo->peritaje->escanercontrol->activo)
<p> <a style="color:hsl(20, 80%, 50%);"  href="/vehiculos?placa={{$vehiculo->placa}}&vehiculoindex=escaner"  tabindex="4">ESCANER</a>
  @else
  <p> <a style="color:rgb(49, 230, 25);"  href="/vehiculos?placa={{$vehiculo->placa}}&vehiculoindex=escaner"  tabindex="4">ESCANER</a>
@endif
    @else
<p> <a  href="/vehiculos?placa={{$vehiculo->placa}}&vehiculoindex=escaner"  tabindex="4">ESCANER</a>
@endif
...
@endif
{{--finacordion peritaje moto completo--}}
...
{{--inicio menu VEHICULO completo otros--}}

@if(($vehiculo->peritaje->tipo=="COMPLETO"||$vehiculo->peritaje->tipo=="OTROS") && ($vehiculo->clase_vehiculo=="Automóvil"||$vehiculo->clase_vehiculo=="Pesados")) 
{{--acordion--}}
...
{{--<p> <a  href="/vehiculos?placa={{$vehiculo->placa}}&vehiculoindex=12"  tabindex="4" target="_blank" rel="noopener">INFORME DEL  PERITAJE</a>--}}
  <p> <a  href="/inspeccion/{{$vehiculo->id}}"  tabindex="4" target="_blank" rel="noopener">INFORME  DEL  PERITAJE</a>      
    <p> <a   href="/vehiculos?placa={{$vehiculo->placa}}&vehiculoindex=paginado"  tabindex="4">AGREGAR PAGINADO</a>
  @if(isset($vehiculo->peritaje->archivocontrol))
  @if($vehiculo->peritaje->archivocontrol->activo)
  <p> <a style="color:hsl(20, 80%, 50%);"  href="/vehiculos?placa={{$vehiculo->placa}}&vehiculoindex=archivo"  tabindex="4">ARCHIVOS</a>
    @else
...
@endif
{{--finacordion peritaje vehiculo completo y otros--}}
